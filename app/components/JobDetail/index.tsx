...
export default function JobDetail({ role }: JobDetailProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: wire this up to your backend / form API (e.g. POST to /api/applications
    // with FormData so the resume file travels along with the rest of the fields).
    setSubmitted(true);
  };
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <div className={styles.metaRow}>
            ...
            <span className={styles.metaChip}>Posted {role.date}</span>
          </div>
      ...
      <div className={styles.layout}>
        ...
        <aside className={styles.aside}>
          <div className={styles.stickyStack}>
            {/* ---- Signature element: ticket-stub apply card ---- */}
            ...
            <div className={styles.contactCard}>
              ...
              <p className={styles.contactBlurb}>
                Questions about this role? Reach out directly and our HR team will get back to you.
              </p>
            ...
            <div className={`${styles.field} ${styles.fieldFull}`}>
              ...
              >
                ...
                <span className={styles.dropzoneText}>
                  {fileName ? (
                    <>
                      <strong>{fileName}</strong> selected — click to replace
                    </>
                  ) : (
                    <>
